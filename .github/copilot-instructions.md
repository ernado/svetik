...
When updating or inspecting database schema, use SCHEMA.md file.
...
To work with database entities in `internal/db`, use `github.com/Masterminds/squirrel`.
Always update `internal/db/SCHEMA.md` when changing database schema.
